...
def topic_to_feature_store(
    ...
    with app.get_consumer() as consumer:
        ...
        # we use input_topic.name instead of 'kafka_input_topic' because
        # when we deploy to Quix Cloud, the original topic name we choose is not
        # necessarily the one that the Quix Cloud Kafka Broker uses internally.
